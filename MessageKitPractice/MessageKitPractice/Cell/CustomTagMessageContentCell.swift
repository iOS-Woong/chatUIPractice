//
//  CustomTagMessageContentCell.swift
//  MessageKitPractice
//
//  Created by 서현웅 on 2023/08/14.
//

import MessageKit
import UIKit

class CustomTagMessageContentCell: CustomMessageContentCell {
    ...
    and sizeCalculator: CustomLayoutSizeCalculator)
  {
    ...
    case .text(let text), .emoji(let text):
      let textColor = displayDelegate.textColor(
        for: message,
        at: indexPath,
        in: messagesCollectionView)
